...
<img src="./../.vuepress/public/img/img_variable_int.jpg" style="width:100%" />

由上图可以看出上图变量啊，b,c的地址是0x404014,0x404018,0x40401c 他们两两相隔4个字节，说明int类型变量占据4个字节的内存空间，如果把int换成short 则两两相隔2字节，则如下图：

<img src="./../.vuepress/public/img/img_variable_short.jpg" style="width:100%" />

同理char 会占据1个字节的内存空间：

<img src="./../.vuepress/public/img/img_Variable_char.jpg" style="width:100%" />
